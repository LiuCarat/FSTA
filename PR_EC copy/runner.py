...
def run(args):
    ...
    print(f"[INFO] EC shape: {list(data['ec'].shape)}")
    ...
    print(f"[INFO] QSR Refinement shape: {list(experiment['oof_qc'].shape)}")
    ...
    training_summary = {
        "individual_ec": individual_ec_metrics,
        "refinement_folds": experiment["refinement_metrics"],
        "representations": ["pr_ec"],
        "PR_EC_PATH": str(pr_ec_path.resolve()),
