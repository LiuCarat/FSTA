...
RESULT_DIR="${PROJECT_ROOT}/results/03_fmri_pheno_qcadv_sparse_directional"
...
"${PYTHON_BIN}" "${PROJECT_ROOT}/scripts/evaluate_qc_leakage.py" \
  --result_dir "${RESULT_DIR}" \
  --folds 5 \
  --output_csv "${RESULT_DIR}/qc_leakage_metrics.csv"
