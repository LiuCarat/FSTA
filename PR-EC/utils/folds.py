...
def prepare_fold_arrays(
    ...
    ec_mean, ec_std = fit_ec_scaler(train_individual_ec)
    ...
    return {
        "train_individual_ec": transform_ec(train_individual_ec, ec_mean, ec_std),
        "val_individual_ec": transform_ec(val_individual_ec, ec_mean, ec_std),
        "test_individual_ec": transform_ec(test_individual_ec, ec_mean, ec_std),
