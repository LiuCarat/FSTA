"""Raw time-series to subject-BEC generation for the FSTA-EC baseline."""
...
from utils.utils import extract_subject_bec


def generate_subject_bec(args, subjects, device):
    """Train FSTA-EC and extract one directed BEC matrix per subject."""
