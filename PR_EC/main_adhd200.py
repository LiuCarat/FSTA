"""Run the ADHD200 Graph-EC experiment."""
import argparse
import sys
...
DATASET_CONFIG = ExperimentProfile(
    ...
    ec_path=ROOT / "PR_EC/outputs/adhd200/adhd200_subject_ec.npz",
    refined_ec_path=ROOT / "PR_EC/outputs/adhd200/adhd200_refined_subject_ec.npz",
    qsr_refined_ec_path=ROOT / "PR_EC/outputs/adhd200/adhd200_qsr_refined_subject_ec.npz",
