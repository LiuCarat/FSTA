"""Run the ADHD200 Graph-BEC experiment."""
import argparse
import sys
...
DATASET_CONFIG = ExperimentProfile(
    ...
    bec_path=ROOT / "PR_EC/outputs/adhd200/adhd200_subject_bec.npz",
    refined_bec_path=ROOT / "PR_EC/outputs/adhd200/adhd200_refined_subject_bec.npz",
    qsr_refined_bec_path=ROOT / "PR_EC/outputs/adhd200/adhd200_qsr_refined_subject_bec.npz",
