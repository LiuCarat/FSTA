"""Generate subject-level Pearson FC matrices and run the EC classifier probe.

This baseline keeps the downstream evaluation identical to Graph-EC. Only the
subject-level representation changes: FSTA/Graph-EC EC is replaced by the
...
def main():
    ...
    print(f"Pearson FC archive: {args.fc_path} shape={archive['ec'].shape}")
