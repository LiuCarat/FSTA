...
```bash
python PR_EC/baseline/Partial-Correlation-FC/run_partial_correlation_fc.py \
  --dataset abide \
  --gpu-id auto
```
...
```text
PR_EC/baseline/Partial-Correlation-FC/outputs/
```
...
python PR_EC/baseline/Partial-Correlation-FC/run_partial_correlation_fc.py \
  --dataset abide_ii \
  --classification-only \
  --fc-path PR_EC/baseline/Partial-Correlation-FC/outputs/subject_partial_correlation_fc_abide_ii.npz
```
