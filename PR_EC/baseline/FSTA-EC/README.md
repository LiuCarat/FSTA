...
```bash
python -m pip install -r PR_EC/baseline/FSTA-EC/requirements.txt
```
...
archive and metrics to `PR_EC/baseline/FSTA-EC/outputs/abide_ii/` by
default.
...
`PR_EC/baseline/FSTA-EC/outputs/adhd200/` directory.
