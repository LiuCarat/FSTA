"""QC-guided self-supervised weak refinement for directed EC matrices."""
...
class QSRECRefiner(nn.Module):
    """Refine EC with fold-level QC sensitivity and neighbor context."""
...
def train_qsr_refiner(
    ...
    metrics.update({
        ...
        "qsr_refined_relative_change": relative_change(ec, refined_array),
