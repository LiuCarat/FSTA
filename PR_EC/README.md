...
python PR_EC/main_adhd200.py --gpu-id 0
...
```text
PR_EC/outputs/abide-i/
PR_EC/outputs/abide-ii/
PR_EC/outputs/adhd200/
```
...
运行结束后，终端会打印每个表示的分类指标均值和标准差。详细的群体边/ROI 分析脚本位于 `PR_EC/analysis/`，说明见 `PR_EC/analysis/README.md`。
